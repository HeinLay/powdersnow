    ...
    <div class="reason-item-group">
      <div class="reason-item">
        ...
        <div class="reason-img">
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/top/img_reason01.png"
          alt="SEO対策の豊富な実績">
        </div>
      ...
      <div class="reason-item">
        ...
        <div class="reason-img">
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/top/img_reason02.png"
          alt="事態収束から回復までワンストップ">
        </div>
      ...
      <div class="reason-item">
        ...
        <div class="reason-img">
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/top/img_reason03.png"
          alt="弁護士との連携による幅広いサービス">
        </div>
      ...
      <div class="reason-item">
        ...
        <div class="reason-img">
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/top/img_reason04.png"
          alt="セキュリティ面のリスクも解決">
        </div>
    ...
    <div class="question-blk">
      <div class="question-col">
        <div class="question-col-img">
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/top/ico_firewall.png"
          alt="Firewall">
        </div>
        <p class="question-txt">テキストテキストテキスト
        テキストテキスト</p>
      </div>
      <div class="question-col">
        <div class="question-col-img">
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/top/ico_person_search.png"
          alt="Search">
        </div>
        <p class="question-txt">テキストテキストテキスト
        テキストテキスト</p>
